            ...
            {userInfo?.affiliate_tier !== "pro" &&
              userInfo?.role === "affiliate" && (
                <Link
                  ...
                  className="inline-flex items-center px-4 py-2 rounded-full text-sm font-medium bg-orange-100 text-orange-800 dark:bg-orange-900/30 dark:text-orange-400 hover:bg-orange-200 dark:hover:bg-orange-900/50 transition mr-[-40px] translate-x-10"
                >
                  <svg
                ...
                {userInfo?.profile_image_url ? (
                  <img
                    ...
                    onError={(e) => {
                      ...
                      fallback.className =
                        "w-8 h-8 bg-gradient-to-br from-[var(--accent-primary)] to-[var(--accent-secondary)] rounded-full flex items-center justify-center";
                      fallback.innerHTML = `<span class="text-sm font-semibold text-white">${
