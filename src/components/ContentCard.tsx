      ...
      <div className="flex items-center gap-2">
        {onView && (
          <button
            ...
            className="p-2 rounded-lg border transition hover:bg-gray-50 dark:hover:bg-gray-700"
            style={{
        ...
        {onDelete && (
          <button
            ...
            className="p-2 rounded-lg border transition hover:bg-red-50 dark:hover:bg-red-900/20"
            style={{
              borderColor: "var(--border-color)",
              color: "#ef4444",
            }}
