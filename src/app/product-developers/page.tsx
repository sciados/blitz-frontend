...
import { Zap, TrendingUp, Users, BarChart3, Sparkles, CheckCircle2, ArrowRight } from "lucide-react";
  ...
  const features = [
    {
      ...
      description: "Just paste your sales page URL. We automatically scrape features, benefits, pain points, and product images."
    },
    {
      emoji: "🤖",
      title: "AI-Powered Research",
      description: "Our RAG system performs competitor analysis and market positioning research automatically."
    },
    {
      emoji: "📊",
      title: "Performance Analytics",
      description: "Track which affiliates are promoting your products and monitor real-time performance metrics."
    },
    {
      emoji: "🎯",
    ...
    },
    {
      ...
      description: "Publish or unpublish products to the library instantly. Full control over visibility."
    },
    {
      emoji: "💰",
      title: "Commission Management",
      description: "Set custom commission rates and track affiliate performance effortlessly."
    }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 text-white">
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-3xl p-12 border border-gray-700 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8">
            Join product developers scaling their reach through automated affiliate marketing.
          </p>
          <EmailSignupForm
      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl p-8 border border-gray-700 text-center">
            ...
            <div className="text-4xl font-bold bg-gradient-to-r from-yellow-400 to-orange-500 bg-clip-text text-transparent">2 Min</div>
            <div className="text-gray-400 mt-2">Average Setup Time</div>
          </div>
          <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl p-8 border border-gray-700 text-center">
            <div className="text-5xl mb-3">📈</div>
            <div className="text-4xl font-bold bg-gradient-to-r from-green-400 to-emerald-500 bg-clip-text text-transparent">10x</div>
      ...
      <div className="max-w-6xl mx-auto px-6 py-20">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-400">Get your products promoted in 3 simple steps</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="relative">
            <div className="bg-gradient-to-br from-purple-900/30 to-purple-800/30 rounded-2xl p-8 border border-purple-700/50 h-full">
              ...
              <p className="text-gray-300">
                Paste your sales page URL, set commission rates, and let our AI automatically compile product intelligence, images, and descriptions.
              </p>
            </div>
          </div>
          ...
          <div className="relative">
            <div className="bg-gradient-to-br from-green-900/30 to-green-800/30 rounded-2xl p-8 border border-green-700/50 h-full">
              ...
              <p className="text-gray-300">
                Watch affiliates create campaigns, monitor performance analytics, and see your sales grow on autopilot.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-6xl mx-auto px-6 py-20">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-400">Everything you need to scale your product promotion</p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((feature, index) => (
            <div key={index} className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl p-6 border border-gray-700 hover:border-gray-600 transition-all duration-300 hover:shadow-lg hover:shadow-purple-500/20">
      ...
      <div className="max-w-6xl mx-auto px-6 py-20">
        <div className="bg-gradient-to-br from-purple-900/20 to-blue-900/20 rounded-3xl p-12 border border-purple-700/30">
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-5xl font-bold mb-4">Why Product Developers Choose Blitz</h2>
          </div>
      ...
      <div className="max-w-4xl mx-auto px-6 py-20">
        <div className="bg-gradient-to-r from-purple-600 to-blue-600 rounded-3xl p-12 text-center">
          ...
          <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
            Join product developers who are reaching more customers through AI-powered affiliate marketing.
          </p>
