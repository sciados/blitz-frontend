...
export default function ImagesPage() {
  ...
  const isSeedImage = (image: GeneratedImage) => {
    ...
    // Check if the image is enhanced/premium
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  {isSeedImage(selectedLibraryImage) ? (
                    <button
                      onClick={() => setIsLibraryModalOpen(false)}
                      className="px-6 py-2 bg-gray-600 hover:bg-gray-700 text-white rounded-lg transition font-medium flex items-center space-x-2"
                    >
                      <svg
                        className="w-5 h-5"
                        fill="none"
