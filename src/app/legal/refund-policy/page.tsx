        ...
        >
          <section className="mb-8 p-6 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
            ...
            <p style={{ color: "var(--text-secondary)" }}>
              At Blitz, we are committed to providing high-quality services and
              ensuring customer satisfaction. This Refund Policy outlines the
              terms and conditions for requesting refunds on our subscription
              plans and services.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="mb-4" style={{ color: "var(--text-secondary)" }}>
              Blitz offers various subscription plans with different features
              and pricing. All subscriptions are:
            </p>
            <ul
          ...
          <section className="mb-8">
            ...
            >
              ...
              <li>
                Cancellation must occur before the trial end date to avoid
                charges
              </li>
              <li>
                After the trial ends, you will be automatically charged for your
                selected plan
              </li>
          ...
          <section className="mb-8">
            ...
            >
              <li>
                Available only for first-time purchases of a subscription plan
              </li>
              <li>
                Must be requested within 30 days of the original purchase date
              </li>
            ...
            >
              <li>
                Email us at <strong>support@blitz.ws</strong> within 30 days of
                purchase
              </li>
              <li>
            ...
            >
              ...
              <li>
                After 30 days, your data may be deleted in accordance with our
                Privacy Policy
              </li>
            </ul>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="mb-4" style={{ color: "var(--text-secondary)" }}>
              <strong>Exception:</strong> Refunds for renewals may be granted at
              our sole discretion in exceptional circumstances, such as
              technical errors or billing mistakes.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            >
              ...
              <li>
                You retain access to paid features until the end of your current
                billing period
              </li>
              <li>
                Your account will automatically convert to a free plan (if
                available)
              </li>
          ...
          <section className="mb-8">
            ...
            <p className="mb-4" style={{ color: "var(--text-secondary)" }}>
              When you cancel, you will continue to have access to paid features
          ...
          <section className="mb-8">
            ...
            <p className="mb-4" style={{ color: "var(--text-secondary)" }}>
              We may issue refunds outside of our standard policy in certain
            ...
            >
              ...
              <li>
                <strong>Service Outages:</strong> If our service was unavailable
            ...
            <p className="mb-4" style={{ color: "var(--text-secondary)" }}>
              Such refunds are granted at our sole discretion and require
          ...
          <section className="mb-8">
            ...
            <p className="mb-4" style={{ color: "var(--text-secondary)" }}>
              If you purchase third-party products or services through affiliate
            ...
            >
              ...
              <li>
                We may assist you in contacting the vendor but cannot guarantee
                refunds
              </li>
            </ul>
          </section>
          ...
          <section className="mb-8">
            ...
            >
              ...
              <li>
                It may take an additional 5-10 business days for the refund to
                appear in your account
              </li>
              <li>
                Processing times vary by payment provider and financial
                institution
              </li>
              <li>
          ...
          <section className="mb-8">
            ...
            >
              ...
              <li>
                Account access will be restored if the chargeback is resolved in
                your favor
              </li>
            </ul>
          </section>
          ...
          <section className="mb-8">
            ...
            >
              ...
              <li>
                Refund requests will be evaluated under the policy in effect at
          ...
          <section className="mb-8">
            ...
            >
              <p className="mb-2" style={{ color: "var(--text-primary)" }}>
                <strong>Email:</strong> support@blitz.ws
              </p>
              <p className="mb-2" style={{ color: "var(--text-primary)" }}>
                <strong>Subject Line:</strong> Refund Request - [Your Account
                Email]
              </p>
              <p className="mb-2" style={{ color: "var(--text-primary)" }}>
