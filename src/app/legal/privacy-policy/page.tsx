        ...
        >
          <section className="mb-8">
            ...
            <p className="mb-4" style={{ color: "var(--text-secondary)" }}>
              Welcome to Blitz ("we," "our," or "us"). We are committed to
              protecting your personal information and your right to privacy.
              This Privacy Policy explains how we collect, use, disclose, and
              safeguard your information when you use our marketing automation
              platform.
            </p>
            <p className="mb-4" style={{ color: "var(--text-secondary)" }}>
              By using Blitz, you agree to the collection and use of information
          ...
          <section className="mb-8">
            ...
            >
              ...
              <li>
                Use our services (campaign data, product URLs, affiliate links)
              </li>
            ...
            <p className="mb-4" style={{ color: "var(--text-secondary)" }}>
              We may collect information about products and URLs you submit for
              analysis. This data is processed to provide you with marketing
              intelligence and campaign optimization services.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            >
              <li>
                ...
                maintain your account and provide platform features
              </li>
              <li>
                <strong>Improve Our Platform:</strong> To understand how users
                interact with our service and make improvements
              </li>
              <li>
                <strong>Communicate With You:</strong> To send updates, security
              ...
              <li>
                <strong>AI Processing:</strong> To generate marketing content
                and product intelligence using AI services
              </li>
            </ul>
          </section>
          ...
          <section className="mb-8">
            ...
            >
              <li>
                ...
                perform services on our behalf (hosting, analytics, AI
                processing)
              </li>
              <li>
            ...
            >
              <li>
                Anthropic Claude AI (for content generation and intelligence
                compilation)
              </li>
          ...
          <section className="mb-8">
            ...
            <p className="mb-4" style={{ color: "var(--text-secondary)" }}>
              ...
              on our platform and store certain information. For detailed
              information about the cookies we use and your choices, please see
              our{" "}
              <a
          ...
          <section className="mb-8 mt-12 p-6 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
            ...
            <p className="mb-4" style={{ color: "var(--text-secondary)" }}>
              ...
              Regulation (GDPR). Our lawful basis for processing your personal
            ...
            >
              ...
              <li>
                ...
                legitimate interests and does not override your rights
              </li>
            </ul>
          </section>
