        ...
        >
          <section className="mb-8">
            ...
            <p className="mb-4" style={{ color: "var(--text-secondary)" }}>
              By accessing or using Blitz ("the Service"), you agree to be bound
              by these Terms & Conditions ("Terms"). If you do not agree to
          ...
          <section className="mb-8">
            ...
            <p className="mb-4" style={{ color: "var(--text-secondary)" }}>
              ...
              the Service, you represent that you are at least 18 years of age
          ...
          <section className="mb-8">
            ...
            >
              ...
              <li>
                Create content that violates FTC guidelines or advertising
                regulations
              </li>
          ...
          <section className="mb-8">
            ...
            >
              <li>
                A non-exclusive license to use, store, and process your content
                to provide the Service
              </li>
              <li>
                Permission to use AI services to analyze and generate content
                based on your inputs
              </li>
              <li>
                The right to create anonymized, aggregated data for analytics
            ...
            <p className="mb-4" style={{ color: "var(--text-secondary)" }}>
              Content generated by our AI services is provided "as is" for your
          ...
          <section className="mb-8">
            ...
            <p className="mb-4" style={{ color: "var(--text-secondary)" }}>
              ...
              Current pricing is available on our website. We reserve the right
              to change our pricing at any time with 30 days' notice to active
              subscribers.
            </p>
            ...
            <p className="mb-4" style={{ color: "var(--text-secondary)" }}>
              ...
              (monthly or annually). Subscriptions automatically renew unless
              canceled before the renewal date. No refunds are provided for
            ...
            <p className="mb-4" style={{ color: "var(--text-secondary)" }}>
              If payment fails, we may suspend or terminate your access to paid
          ...
          <section className="mb-8">
            ...
            >
              ...
              <li>
                Use of the Service will result in any particular business
                outcomes or revenue
              </li>
            </ul>
            ...
            <p className="mb-4" style={{ color: "var(--text-secondary)" }}>
              TO THE MAXIMUM EXTENT PERMITTED BY LAW, BLITZ AND ITS AFFILIATES,
              OFFICERS, DIRECTORS, EMPLOYEES, OR AGENTS SHALL NOT BE LIABLE FOR
              ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE
              DAMAGES, INCLUDING LOSS OF PROFITS, DATA, OR OTHER INTANGIBLE
          ...
          <section className="mb-8">
            ...
            <p className="mb-4" style={{ color: "var(--text-secondary)" }}>
              You agree to indemnify, defend, and hold harmless Blitz and its
          ...
          <section className="mb-8">
            ...
            >
              ...
              <li>
                Include proper affiliate disclosures in all promotional content
              </li>
              <li>
                Comply with the terms and conditions of affiliate networks you
                join
              </li>
            ...
            <p className="mb-4" style={{ color: "var(--text-secondary)" }}>
              Our compliance checking tools are provided as a convenience only.
              You are solely responsible for ensuring your content complies with
          ...
          <section className="mb-8">
            ...
            <p className="mb-4" style={{ color: "var(--text-secondary)" }}>
              ...
              the laws of the jurisdiction in which Blitz operates, without
            ...
            <p className="mb-4" style={{ color: "var(--text-secondary)" }}>
              ...
              only and not as part of a class action, consolidated, or
          ...
          <section className="mb-8">
            ...
            <p className="mb-4" style={{ color: "var(--text-secondary)" }}>
              ...
              agreement between you and Blitz regarding your use of the Service
          ...
          <section className="mb-8 mt-12 p-6 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg border border-yellow-200 dark:border-yellow-800">
            ...
            <p style={{ color: "var(--text-secondary)" }}>
              By using Blitz, you acknowledge that you have read, understood,
              and agree to be bound by these Terms & Conditions. If you do not
              agree to these Terms, you must discontinue use of the Service
              immediately.
            </p>
          </section>
        </div>
